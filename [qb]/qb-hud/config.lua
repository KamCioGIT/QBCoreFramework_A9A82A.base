...
Config.Menu = {
    ...
    isLowFuelChecked = false,            -- isLowFuelChecked
    ...
    isCompassShowChecked = false,        -- isShowCompassChecked
    isShowStreetsChecked = false,        -- isShowStreetsChecked
    isPointerShowChecked = false,        -- isPointerShowChecked
    isDegreesShowChecked = false,        -- isDegreesShowChecked
