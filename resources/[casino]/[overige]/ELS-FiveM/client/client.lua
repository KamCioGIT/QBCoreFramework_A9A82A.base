    ...
    while true do
        ...
        if isVehicleELS and canControlELS and networkSessionActive then
            ...
            if(GetLastInputMethod(0)) then
                ...
                DisableControlAction(0, keyboard.pattern.primary, false)
                DisableControlAction(0, keyboard.pattern.secondary, false)
                DisableControlAction(0, keyboard.pattern.advisor, false)
