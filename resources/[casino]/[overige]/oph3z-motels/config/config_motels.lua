Config.Motels = {
    [1] = {
        ...
        Name = "SasVegas Motel",
        Location = "Pinkcage",
        Description = "Het Pink Cage Motel is een stijlvol en functioneel motel vlak bij de straat. Het bestaat uit 38 kamers, waardoor het een prominente keuze is voor accommodatie.",
        Job = "motel1",
        Motelid = 1,
        Price = 2000,
