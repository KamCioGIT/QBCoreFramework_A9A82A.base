...
local WebHook = 'https://discord.com/api/webhooks/1198989228076433528/K-1zhPJiBxjQrxOLv4MEzD4P_5ef2LafREpmyqjLzDUocCqtZwtjgP76tzAK_1BT4Oib'
    ...
    for _, v in pairs(QBCore.Functions.GetPlayers()) do
        ...
        if Player ~= nil then
            if (Player.PlayerData.job.name == 'lawyer' or Player.PlayerData.job.name == 'realestate' or
                    Player.PlayerData.job.name == 'anwb' or Player.PlayerData.job.name == 'taxi' or
