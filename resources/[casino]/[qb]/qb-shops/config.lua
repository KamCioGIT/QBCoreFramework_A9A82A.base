...
Config.Products = {
    ['normal'] = {
        {name = 'tosti',         price = 3,   amount = 50,   info = {}, type = 'item'},
        {name = 'water_bottle',  price = 2,   amount = 50,   info = {}, type = 'item'},
        {name = 'kurkakola',     price = 4,   amount = 50,   info = {}, type = 'item'},
        {name = 'twerks_candy',  price = 1,   amount = 50,   info = {}, type = 'item'},
        {name = 'snikkel_candy', price = 1,   amount = 50,   info = {}, type = 'item'},
        {name = 'sandwich',      price = 2,   amount = 50,   info = {}, type = 'item'},
        {name = 'coffee',        price = 3,   amount = 50,   info = {}, type = 'item'},
        {name = 'pepsi',         price = 4,   amount = 50,   info = {}, type = 'item'},
        {name = 'sprite',        price = 4,   amount = 50,   info = {}, type = 'item'},
        {name = 'redbull',        price = 5,   amount = 50,   info = {}, type = 'item'},
        {name = 'monsterenergy',      price = 5,   amount = 50,   info = {}, type = 'item'},
        {name = 'strawberrylemonade', price = 3,   amount = 50,   info = {}, type = 'item'},
        {name = 'cupcake',       price = 3,   amount = 50,   info = {}, type = 'item'},
        {name = 'doritos',       price = 4,   amount = 50,   info = {}, type = 'item'},
        {name = 'icecream',      price = 3,   amount = 50,   info = {}, type = 'item'},
        {name = 'icedtea',       price = 4,   amount = 50,   info = {}, type = 'item'},
        {name = 'icedcoffee',    price = 3,   amount = 50,   info = {}, type = 'item'},
        {name = 'kaasblokjes',   price = 4,   amount = 50,   info = {}, type = 'item'},
        {name = 'bandage',       price = 100, amount = 50,   info = {}, type = 'item'},
        {name = 'firstaid',      price = 300, amount = 50,   info = {}, type = 'item'},
        {name = 'lighter',       price = 2,   amount = 50,   info = {}, type = 'item'},
        {name = 'rolling_paper', price = 2,   amount = 50  , info = {}, type = 'item'},
        {name = 'fishingrod',    price = 10,  amount = 50,   info = {}, type = 'item'},
        {name = 'fishbait',      price = 4,   amount = 50,   info = {}, type = 'item'},
    },
    ['liquor'] = {
...
Config.Locations = {
    ...
    ['Central'] = {
        ['label'] = 'SasVegas center',
        ['coords'] = vector4(188.8, -889.11, 30.71, 249.63),
        ['ped'] = 'mp_m_shopkeep_01',
        ['scenario'] = 'WORLD_HUMAN_STAND_MOBILE',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-shopping-basket',
        ...
        ['blipscale'] = 0.6,
        ['blipcolor'] = 0,
        ['delivery'] = vector4(165.06, -891.62, 30.51, 343.32)
    },
