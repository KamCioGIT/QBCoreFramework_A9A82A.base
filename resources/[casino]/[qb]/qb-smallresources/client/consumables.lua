...
RegisterNetEvent('consumables:client:Useweed_skunk_cbd_joint', function()
    QBCore.Functions.Progressbar('smoke_joint', Lang:t('consumables.joint_progress'), 1500, false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
...
RegisterNetEvent('consumables:client:Useweed_white_widow_cbd_joint', function()
    QBCore.Functions.Progressbar('smoke_joint', Lang:t('consumables.joint_progress'), 1500, false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        ...
        TriggerEvent('inventory:client:ItemBox', QBCore.Shared.Items['weed_white_widow_cbd_joint'], 'remove')
        if IsPedInAnyVehicle(PlayerPedId(), false) then
            TriggerEvent('animations:client:EmoteCommandStart', { 'smoke3' })
        else
            TriggerEvent('animations:client:EmoteCommandStart', { 'smokeweed' })
...
RegisterNetEvent('consumables:client:Useweed_og_kush_cbd_joint', function()
    QBCore.Functions.Progressbar('smoke_joint', Lang:t('consumables.joint_progress'), 1500, false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        ...
        TriggerEvent('inventory:client:ItemBox', QBCore.Shared.Items['weed_og_kush_cbd_joint'], 'remove')
        if IsPedInAnyVehicle(PlayerPedId(), false) then
            TriggerEvent('animations:client:EmoteCommandStart', { 'smoke3' })
        else
            TriggerEvent('animations:client:EmoteCommandStart', { 'smokeweed' })
...
RegisterNetEvent('consumables:client:Useweed_ak47_cbd_joint', function()
    QBCore.Functions.Progressbar('smoke_joint', Lang:t('consumables.joint_progress'), 1500, false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
