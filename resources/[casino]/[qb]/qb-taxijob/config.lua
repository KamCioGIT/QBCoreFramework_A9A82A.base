Config = {
    ...
    Location = vector3(363.5245, -1586.6687, 29.2928), -- map blip position
    parkLocation = vector3(371.3790, -1609.0526, 29.2927), -- vehicle garage location

    Duty = vector3(357.9401, -1591.5587, 29.2928),
    ...
    CabSpawns = {
        vector4(370.5541, -1622.6898, 28.9359, 320.9928),
        vector4(372.7955, -1624.6376, 28.9364, 319.8748),
        vector4(384.4888, -1634.5892, 28.9358, 319.8737),
        vector4(386.9876, -1636.9662, 28.9371, 317.3812),
        vector4(395.2469, -1626.3055, 28.9360, 47.6895),
        vector4(397.2691, -1623.9674, 28.9370, 49.7738),
        vector4(398.9872, -1621.3816, 28.9356, 51.9594),
        vector4(388.6635, -1612.7354, 28.9364, 230.3011)
    },
}