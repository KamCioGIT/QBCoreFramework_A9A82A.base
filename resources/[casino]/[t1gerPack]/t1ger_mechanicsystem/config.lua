Config = {
	...
	ShopCreator = {
		grades = { -- default job grades that are created, once a shop is being created
			[1] = {grade = 0, name = 'Rekruut', label = 'Rekruut', salary = 50},
			[2] = {grade = 1, name = 'gevorderde', label = 'Gevorderde', salary = 75},
			[3] = {grade = 2, name = 'ervaren', label = 'Ervaren', salary = 100},
			[4] = {grade = 2, name = 'gevorderd', label = 'Gevorderd niveau', salary = 125},
			[5] = {grade = 3, name = 'manager', label = 'Manager', salary = 150, isboss = true}
	...
	Markers = {
		['duty'] = {
			...
			blip = {enable = true, name = 'In/uit dienst', sprite = 280, display = 4, scale = 0.65, color = 0}, -- blip settings
			renderDist = 5.0, -- thread render dist to show marker
			interact = {keybind = 38, dist = 1.0, textUi = '[E] - Dienst', icon = 'toggle-on', position = 'right-center', style = {borderRadius = 0, backgroundColor = '#48BB78', color = 'white'}},
			menuTitle = 'In/uit dienst', -- menu title in context menu
			icon = 'toggle-on'-- icon in context menu
		},
		['boss'] = {
			enable = true,
			showMarker = true, -- show a marker in-game to see where to interact
			blip = {enable = true, name = 'Management Menu', sprite = 164, display = 4, scale = 0.65, color = 0}, -- blip settings
			renderDist = 5.0, -- thread render dist to show marker
			interact = {keybind = 38, dist = 1.0, textUi = '[E] - Manager Menu', icon = 'crown', position = 'right-center', style = {borderRadius = 0, backgroundColor = '#48BB78', color = 'white'}},
			menuTitle = 'Management', -- menu title in context menu
		...
		['garage'] = {
			...
			interact = {keybind = 38, dist = 1.0, textUi = '[E] - Garage', icon = 'car', position = 'right-center', style = {borderRadius = 0, backgroundColor = '#48BB78', color = 'white'}},
		...
		['storage'] = {
			enable = true,
			showMarker = true, -- show a marker in-game to see where to interact
			blip = {enable = true, name = 'Opslag', sprite = 587, display = 4, scale = 0.65, color = 0}, -- blip settings
			renderDist = 5.0, -- thread render dist to show marker
			interact = {keybind = 38, dist = 1.0, textUi = '[E] - Opslag', icon = 'box', position = 'right-center', style = {borderRadius = 0, backgroundColor = '#48BB78', color = 'white'}},
			menuTitle = 'Opslag',-- menu title in context menu
		...
		['workbench'] = {
			...
			blip = {enable = true, name = 'Werkbank', sprite = 566, display = 4, scale = 0.65, color = 0}, -- blip settings
			renderDist = 5.0, -- thread render dist to show marker
			interact = {keybind = 38, dist = 1.0, textUi = '[E] - Werkbank', icon = 'toolbox', position = 'right-center', style = {borderRadius = 0, backgroundColor = '#48BB78', color = 'white'}},
			menuTitle = 'Werkbank',-- menu title in context menu
			icon = 'toolbox', -- icon in context menu
		},
		['repair'] = {
			enable = true,
			showMarker = true, -- show a marker in-game to see where to interact
			blip = {enable = true, name = 'Snelle reparatie', sprite = 402, display = 4, scale = 0.65, color = 0}, -- blip settings
			renderDist = 5.0, -- thread render dist to show marker
			interact = {keybind = 38, dist = 1.0, textUi = '[E] - Repareer', icon = 'screwdriver-wrench', position = 'right-center', style = {borderRadius = 0, backgroundColor = '#48BB78', color = 'white'}},
			menuTitle = 'Repareer',-- menu title in context menu
			icon = 'screwdriver-wrench', -- icon in context menu
			settings = {
				price = 200, -- price to quick repair
				duration = 2500, -- duration in ms for quick repair
				progressLabel = 'Voertuig snel repareren',
	...
	CarJack = { -- Car Jack
		...
		Keybind = 38,
		HelpText = '~INPUT_PICKUP~ Autokrik bevestigen',
	...
	Degradation = {
		...
		Malfunction = { -- 3 effects (ok is not accounted and is max, min is 0)
			failure = {label = 'mechanische storingen', health = 0, msg = '%s (%s%s) vereist vervanging, mechanisch defect.'}, -- value equal to or below 0 is failure
			defect = {label = 'DEFECT', health = 25, msg = '%s (%s%s) is defect, binnenkort mechanisch defect.'}, -- value equal to or below 25 is defect, (min = failure.health)
			worn = {label = 'VERSLETEN', health = 50, msg = '%s (%s%s) is versleten, snel defect.'}, -- value equal to or below  50 is WORN, (min = defect.health)
			good = {label = 'GOED', health = 100}, -- value equal to or below 100 (max) is OK, (min = worn.health)
		},
	...
	Parts = {
		['health'] = { -- health 0-100% affected from in-game crashes, randomly. when below certain values, car acts weird based on parts and its value.
			...
			['fuel_pump'] = {label = 'Benzine pomp', id = 2, health = 100.0, itemId = 2, service = {'air_filter', 'fuel_filter', 'spark_plugs'}, icon = 'https://i.ibb.co/dLz16dK/fuel-pump.png'},
			-- high fuel consumption and vehicle stalling 
			['brakes'] = {label = 'Remmen', id = 3, health = 100.0, itemId = 3, service = {'brake_fluid'}, icon = 'https://i.ibb.co/h1xTL7B/brakes.png'},
			-- poor braking
			['drive_shaft'] = {label = 'Aandrijfas', id = 4, health = 100.0, itemId = 4, service = {'steering_fluid', 'drive_belt'}, icon = 'https://i.ibb.co/n3nxk31/drive-shaft.png'},
			-- poor steering, random steer while driving
			['alternator'] = {label = 'Dynamo', 	id = 5, health = 100.0, itemId = 5, service = {'drive_belt'}, icon = 'https://i.ibb.co/Ct1cHpT/alternator.png'},
			-- if engine is running and speed <= 0 then it kills engine, making the vehicle unable to start
			['clutch'] = 	{label = 'Koppeling', 		id = 6, health = 100.0, itemId = 6, service = {'transmission_fluid', 'flywheel'}, icon = 'https://i.ibb.co/5WLn48d/clutch.png'},
			--  difficult gear shifts, slower shifts
		},
		['service'] = { -- service parts based on in-game mileage. Set mileages here for each part. 
			['oil_filter'] = {label 		= 'Olie + Filter',	id = 1, mileage = 50.0, itemId = 1, icon = 'https://i.ibb.co/X3mZwK5/oil-filter.png'},
			['air_filter'] = {label 		= 'Luchtfilter',	id = 2, mileage = 120.0, itemId = 2, icon = 'https://i.ibb.co/TTWRjdq/air-filter.png'},
			['fuel_filter'] = {label 		= 'Brandstoffilter',	id = 3, mileage = 400.0, itemId = 3, icon = 'https://i.ibb.co/wyp34J9/fuel-filter.png'},
			['coolant'] = {label 			= 'Koelvloeistof',	id = 4, mileage = 300.0, itemId = 4, icon = 'https://i.ibb.co/tXRgyDZ/coolant.png'},
			['brake_fluid'] = {label 		= 'Remvloeistof',	id = 5, mileage = 300.0, itemId = 5, icon = 'https://i.ibb.co/HG6zvmD/brake-fluid.png'},
			['steering_fluid'] = {label 	= 'Stuurbekrachtigingsvloeistof', 	id = 6, mileage = 500.0, itemId = 6, icon = 'https://i.ibb.co/D7vrVv6/steering-fluid.png'},
			['transmission_fluid'] = {label = 'Transmissievloeistof',	id = 7, mileage = 450.0, itemId = 7, icon = 'https://i.ibb.co/QCtZKgY/transmission-fluid.png'},
			['spark_plugs'] = {label 		= 'Bougies',	id = 8, mileage = 400.0, itemId = 8, icon = 'https://i.ibb.co/1nvYGv2/spark-plugs.png'},
			['drive_belt'] = {label 		= 'Aandrijfriem',	id = 9, mileage = 600.0, itemId = 9, icon = 'https://i.ibb.co/k88MBHt/drive-belt.png'},
			['flywheel'] = {label 			= 'Vliegwiel',	id = 10, mileage = 900.0, itemId = 10, icon = 'https://i.ibb.co/CJ41qnJ/flywheel.png'},
			['tires'] = {label 				= 'Banden',	id = 11, mileage = 600.0, itemId = 11, icon = 'https://i.ibb.co/jDfnrWk/tires.png'},
		},
	},
	...
	Service = {
		...
		Progbar = {duration = 2500, label = 'Vervangen: %s'},
	...
	BodyRepair = {
		...
		Inspection = {
			marker = {type = 20, scale = {0.35, 0.35, 0.35}, rgba = {255, 255, 0, 100}},
			textUi = {label = '[E] Inspecteren / [X] Afbreken', pos = 'right-center', icon = 'car'},
			keybind = 38, -- [E]
		...
		WheelsDropIssue = false, -- if u problem with duplicating wheels, set to true. It will instead use tyre burst until fivem fixes native.
		Install = {
			...
			target = {label = 'Installeren %s', icon = 'fa-solid fa-car', distance = 5.0},
			cancel = {textUi = '[X] Installatie annuleren', keybind = 252}
		},
		SetFixed = { -- this is values to apply after the whole body repair process is done.
			bodyHealth = 1000.0,
	...
	RepairStations = {
		[1] = {
			pos = vector3(433.62, -1018.28, 28.84), -- MRPD
			jobs = {'police', 'police2'},
			blip = {enable = true, label = 'Repair Station', sprite = 402, color = 58, scale = 1.0},
			marker = {dist = 5.0, type = 20, scale = {0.35, 0.35, 0.35}, rgba = {255, 99, 71, 100}},
			progbar = {duration = 2500, label = 'Fixing Vehicle'},
			interact = {keybind = 38, dist = 1.2, textUi = '[E] - Repair Station', icon = 'wrench', position = 'right-center', style = {borderRadius = 0, backgroundColor = '#48BB78', color = 'white'}},
		},
		[2] = {
			pos = vector3(344.39, -553.79, 28.74), -- MRPD
			jobs = {'ambulance'},
			blip = {enable = true, label = 'Repair Station', sprite = 402, color = 58, scale = 1.0},
			marker = {dist = 5.0, type = 20, scale = {0.35, 0.35, 0.35}, rgba = {255, 99, 71, 100}},
			progbar = {duration = 2500, label = 'Fixing Vehicle'},
	...
	Emotes = {
		...
		Props = {
			...
			['-2146714905'] = {label = 'Con Sign', itemId = 5, model = 'prop_consign_02a', push = true, bone = 28422, pos = {0.0,0.2,-1.05}, rot = {-195.0,-180.0,180.0}},
			['-205311355'] = {label = 'Road Barrier', itemId = 6, model = 'prop_mp_barrier_02b', push = true, bone = 28422, pos = {0.0,0.2,-1.05}, rot = {-195.0,-180.0,180.0}}
		}
	},
	...
	BreakDowns = {
		Label = 'Break Downs',
		Icon = 'truck-pickup',
		Description = 'Het NPC-voertuig heeft pech en het voertuig kan niet ter plaatse worden gerepareerd. Breng een sleepwagen en sleep het voertuig terug naar uw monteurwerkplaats.',
		...
		RandomVehicles = {"amdbx", "aaq4", "m2", "sandero"}, -- script scrambles random vehicle from this list to spawn.
	...
	RoadSideRepairs = {
		Label = 'Reparaties langs de weg',
		Icon = 'screwdriver-wrench',
		Description = 'Het NPC-voertuig kan een lege accu hebben, geen brandstof meer hebben of een kapotte band. Neem je gereedschap mee en zorg ervoor dat de NPC weer aan de slag kan.',
		TravelDistance = 1000.0, -- Set minimum travel distance from ply coords to NPC job location.
		Blip = {label = 'Road Side Repair', sprite = 1, color = 5, scale = 0.7, route = {enable = true, color = 5}},
		RandomVehicles = {"logan", "ap2", "jeepreneg", "lambose"}, -- script scrambles random vehicle from this list to spawn.
		Marker = {distance = 5, type = 20, scale = {0.35, 0.35, 0.35}, rgba = {255, 99, 71, 100}},
		Keybind = 38,
		TextUi = '[E]',
		CollectCash = {markerType = 29, textUi = '[E] Contant geld innen', keybind = 38},
		['fuel'] = {
			message = 'Het voertuig had geen brandstof meer, tank deze bij!',
			textUi = 'Fuel Vehicle',
		...
		['battery'] = {
			message = 'De accu van het voertuig is leeg, laad de accu op!',
		...
		['tire'] = {
			message = 'Eén van de banden is lek, repareer de band!',
			textUi = 'Fix Tire',
	...
	ScrapCars = {
		Label = 'Scrap Cars',
		Icon = 'recycle',
		Description = 'Pak een sloopvoertuig op en zet het neer op de schroothoop om het voertuig te demonteren en wat materiaal te ontvangen.',
		TravelDistance = 1000.0, -- Set minimum travel distance from ply coords to NPC job location.
		Blip = {label = 'Scrap Car - Pick Up', sprite = 1, color = 5, scale = 0.7, route = {enable = true, color = 5}},
		RandomVehicles = {"rcf", "levante", "c6320", "mbc63"}, -- script scrambles random vehicle from this list to spawn.
		Marker = {distance = 5, type = 20, scale = {0.35, 0.35, 0.35}, rgba = {255, 99, 71, 100}},
		Keybind = 38,
		TextUi = '[E]',
		Scrapyard = {
		...
		Actions = {
			['drop_off'] = {
				...
				textUi = 'Zet/parkeer het voertuig binnen de markering',
			},
			['inspect'] = {
				keybind = 38,
				textUi = '[E] Sloopvoertuig',
			},
			['collect'] = {
				keybind = 38,
				textUi = '[E] Betaling innen',
				anim = {dict = 'mp_common', name = 'givetake2_a', flag = 49, blendIn = 4.0, blendOut = -4.0},
	...
	PushVehicle = {
		...
		DrawText = {
			...
			str1 = 'Houd ~g~[LEFT SHIFT]~s~ ingedrukt om het voertuig te duwen',
			str2 = '~r~[BACKSPACE]~s~ om het duwen te stoppen',
			interactDist = 1.2 -- distance to key press works
		},
		HelpText = 'Stuur het voertuig met ~INPUT_MOVE_LEFT_ONLY~ en ~INPUT_MOVE_RIGHT_ONLY~',
	...
	FlipVehicle = {
		...
		DrawText = {
			dist = 4.0, -- distance to draw text visible
			str = '~r~[E]~s~ Voertuig omkeren', -- draw text 
	...
	UnlockVehicle = {
		...
		DrawText = {
			dist = 4.0, -- distance to draw text visible
			str = '~r~[E]~s~ Voertuig ontgrendelen', -- draw text 
			keybind = 38, -- DEFAULT KEY: [E]
			interactDist = 1.0 -- distance to key press works
		},
	...
	ImpoundVehicle = {
		...
		DrawText = {
			dist = 4.0, -- distance to draw text visible
			str = '~r~[E]~s~ Voertuig in beslag genomen', -- draw text 
			keybind = 38, -- DEFAULT KEY: [E]
			interactDist = 1.0 -- distance to key press works
		},
		Scenario = 'CODE_HUMAN_MEDIC_TEND_TO_DEAD',
	...
	FlatbedTowing = {
		Enable = true, -- set to false to disable
		Trucks = {
			['flatbed'] = {offset = {0.0, -2.3, 1.1}, boneIndex_name = 'bodyshell'}
		},
		Command = 'tow',
		DrawText = {
			attach = '~g~[E]~s~ Voertuig bevestigen',
			detach = '~g~[G]~s~ Voertuig loskoppelen',
			dist = 5.0
		},
		...
		Blacklisted = {'flatbed'} -- vehicles that cannot be attached to flatbed
	},
