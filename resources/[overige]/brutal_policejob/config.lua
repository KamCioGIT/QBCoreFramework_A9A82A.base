Config = {
    ...
    Billing = 'okokBilling', -- 'okokBilling' / 'esx_billing' / 'jaksam_billing'
    TextUI = 'QBDrawText', -- 'ox_lib' / 'okokTextUI' / 'ESXTextUI' / 'QBDrawText' // Custom can be add in the cl_utils.lua!!!
    ...
    PoliceStations = {
        ...
        ['Police Department'] = {
            ...
            Duty = vector3(441.16, -975.99, 30.69), -- Duty ON / OFF coords
            DutyBlips = true, -- With this the cops can see the other cops in the map.

            Cloakrooms = {
                vector3(453.93, -991.17, 30.69),
                -- You can add more...
            },
