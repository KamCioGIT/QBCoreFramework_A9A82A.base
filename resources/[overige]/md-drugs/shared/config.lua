...
Config.CokeTeleIn = vector3(198.16, -1276.92, 29.33)-- where you target to go inside pstcode 834 / 835
...
---------------- Crack locations
Config.makecrack = vector3(2434.07, 4969.39, 42.35) -- make crack with baking soda with cut coke 1-3 pstcode 106 / 107 
...
Config.rawxtcloc = vector3(898.51, -960.2, 39.28) --  where to combine the 2 ingridents to make raw xtc pstcode 768
Config.stamp = vector3(895.98, -963.57, 39.28) --  where to stamp pills
Config.buypress = vector3(879.5, -962.61, 27.86)--  Where you buy your presses
...
-------------- lean
Config.SyrupVendor = vector3(491.27, -588.16, 24.71) -- where the mission ped starts pstcode 758
Config.StartLoc = {
...
Config.Travellingmerchant = { ------------ these are the random locations the merchant can spawn on script start. whatever you want for the merchant is in Config.Items right below
	vector3(186.83, -1197.65, 29.3),
	vector3(243.27, -2000.56, 19.94),
	vector3(292.0091, -285.9230, 53.9807),
    vector3(-278.87, 6172.66, 31.5),
}
