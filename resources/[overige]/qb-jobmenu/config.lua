    ...
    Jobs = {
        ["police"] = {
            menuoptions = {
                ...
                {icon = "fas fa-handcuffs",header = "submenu.h_cuffplayer", txt = "submenu.t_cuffplayer", event = "police:client:CuffPlayerSoft", submenu = "policeinteractions", subheader = ""},
        ...
        ["mechanic"] = {
            menuoptions = {
                {icon = "fas fa-truck-pickup",header = "menu.h_towvehicle", txt = "menu.t_towvehicle", event = "qb-tow:client:TowVehicle",submenu = "", subheader = "", rank = 1},
            }
        },
        ["taxi"] = {
            menuoptions = {
                {icon = "fas fa-eye-slash",header = "menu.h_togglemeter", txt = "menu.t_togglemeter", event = "qb-taxi:client:toggleMeter",submenu = "", subheader = "", rank = 1},
                {icon = "fas fa-hourglass-start",header = "menu.h_togglemouse", txt = "menu.t_togglemouse", event = "qb-taxi:client:enableMeter",submenu = "", subheader = "", rank = 1},
                {icon = "fas fa-taxi",header = "menu.h_npc_mission", txt = "menu.t_npc_mission", event = "qb-taxi:client:DoTaxiNpc",submenu = "", subheader = "", rank = 2},
            }
        },
    }
}