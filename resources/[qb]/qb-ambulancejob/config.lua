...
Config.Locations = {                -- Edit the various interaction points for players or create new ones
    ['checking'] = {
        [1] = vector3(-1852.82, -338.32, 49.44),
        [2] = vector3(-254.54, 6331.78, 32.43), -- paleto
    },
    ['duty'] = {
        [1] = vector3(-1819.0, -360.04, 49.45), --ocean
        [2] = vector3(-1815.83, -354.42, 49.46),  --ocean
    },
    ['vehicle'] = {
        [1] = vector4(-1847.3, -375.85, 40.78, 233.15), --ocean
        [2] = vector4(-234.28, 6329.16, 32.15, 222.5),
    },
    ['helicopter'] = {
        [1] = vector4(-1831.55, -380.47, 58.04, 341.48), --ocean
        [2] = vector4(-1866.31, -351.2, 58.04, 316.25), --ocean
    },
    ['armory'] = {
    ...
    ['roof'] = {
        [1] = vector4(-1827.82, -343.22, 92.61, 120.6),
    },
    ['main'] = {
        [1] = vector3(-1852.82, -338.32, 49.44),
    },
    ['stash'] = {
        [1] = vector3(-1824.27, -381.82, 49.41),
    },
    ['beds'] = {
        { coords = vector4(-1865.73, -332.25, 50.19, 328.25),    taken = false, model = 1631638868 },
        { coords = vector4(-1862.53, -334.3, 50.19, 314.79),  taken = false, model = 1631638868 },
        { coords = vector4(-1868.63, -329.95, 50.19, 316.88),   taken = false, model = 2117668672 },
        { coords = vector4(-1872.02, -326.93, 50.19, 319.48),    taken = false, model = 2117668672 },
        { coords = vector4(-1875.09, -324.55, 50.19, 320.15),   taken = false, model = 2117668672 },
        { coords = vector4(-1875.33, -318.02, 50.19, 137.25),  taken = false, model = -1091386327 },
        { coords = vector4(-1878.43, -322.18, 50.19, 324.1),  taken = false, model = -1091386327 },
        { coords = vector4(-1872.05, -320.60, 50.19, 140.25),  taken = false, model = -1091386327 },
        { coords = vector4(-1868.89, -323.14, 50.19, 139.26),  taken = false, model = -1091386327 },
        --- paleto
    ...
    ['stations'] = {
        { label = Lang:t('info.pb_hospital'), coords = vector3(-1866.31, -351.2, 58.04) }
    }
}
