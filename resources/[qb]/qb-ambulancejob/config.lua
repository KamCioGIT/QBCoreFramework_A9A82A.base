...
Config.Locations = {                -- Edit the various interaction points for players or create new ones
    ['checking'] = {
        [1] = vector3(-1852.82, -338.87, 49.44),
        [2] = vector3(-254.54, 6331.78, 32.43), -- paleto
    },
    ['duty'] = {
        [1] = vector3(-1820.67, -351.0, 49.46), --vrouwen
    },
    ['vehicle'] = {
        [1] = vector4(-1846.38, -373.87, 40.83, 230.21), --P2
        [2] = vector4(-1849.39, -377.9, 40.83, 237.92), --P1
    },
    ['helicopter'] = {
        [1] = vector4(-1867.3584, -352.5922, 58.0336, 311.6760), --ocean 1
        [2] = vector4(-1830.8168, -378.2191, 58.0403, 318.8337), --ocean 2
    },
    ['armory'] = {
    ...
    ['roof'] = {
        [1] = vector4(-1866.8301, -321.5354, 92.5676, 318.5754),
    },
    ['main'] = {
        [1] = vector3(-1859.8533, -352.8706, 49.2393),
    },
    ['stash'] = {
        [1] = vector3(-1825.7219, -383.4883, 49.4055),
    },
    ['beds'] = {
        { coords = vector4(-1862.7219, -334.3850, 50.1888, 320.1774),    taken = false, model = 1631638868 },
        { coords = vector4(-1865.8219, -332.1995, 50.1943, 320.5186),  taken = false, model = 1631638868 },
        { coords = vector4(-1868.5276, -330.0228, 50.1888, 313.3938),   taken = false, model = 2117668672 },
        { coords = vector4(-1872.1074, -326.9956, 50.1887, 322.8840),    taken = false, model = 2117668672 },
        { coords = vector4(-1875.1233, -324.7438, 50.1887, 325.4073),   taken = false, model = 2117668672 },
        { coords = vector4(-1878.4365, -322.0346, 50.1888, 323.4763),  taken = false, model = -1091386327 },
        { coords = vector4(-1875.2633, -317.9988, 50.1887, 145.4874),  taken = false, model = -1091386327 },
        { coords = vector4(-1871.8464, -320.5267, 50.1887, 142.1278),  taken = false, model = -1091386327 },
        { coords = vector4(-1868.9259, -323.1200, 50.1887, 150.3082),  taken = false, model = -1091386327 },
        --- paleto
    ...
    ['stations'] = {
        { label = Lang:t('info.pb_hospital'), coords = vector3(-1859.8533, -352.8706, 49.2393) }
    }
}
