...
Config.Discord = {
    ...
    iconLarge = 'SasVegasRP Large',                               -- The name of the large icon
    iconLargeHoverText = 'SasVegasRP', -- The hover text of the large icon
    iconSmall = 'small_logo_name',                         -- The name of the small icon
    iconSmallHoverText = 'SasVegasRP', -- The hover text of the small icon
    ...
    buttons = {
        {
            text = 'Join Server',
            url = 'fivem://85.215.81.46/localhost:30120'
        },
        {
            text = 'Join Discord',
            url = 'https://discord.gg/bECZdaADpY'
        }
    }
}
...
Config.Consumables = {
    ...
    drink = { -- default drink items
        ...
        ['prime'] = math.random(40, 50),
        ['pepsi'] = math.random(40, 50),
