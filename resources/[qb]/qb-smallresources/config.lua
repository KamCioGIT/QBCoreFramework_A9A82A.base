...
Config.Discord = {
    ...
    applicationId = '1196963537805922486',                   -- The discord application id
    iconLarge = 'sasvegasrp_large',                               -- The name of the large icon
    iconLargeHoverText = 'De leukste server van Nederland en België', -- The hover text of the large icon
    iconSmall = 'sasvegasrp_small',                         -- The name of the small icon
    iconSmallHoverText = 'De leukste server van Nederland en België', -- The hover text of the small icon
    ...
    buttons = {
        {
            text = 'Join Server',
            url = 'fivem://connect/sasvegasrp.nl:30120'
        },
        {
            text = 'Join Discord',
            url = 'https://discord.gg/rRSEqcjbAW'
        }
    }
}
...
Config.Consumables = {
    eat = { -- default food items
        ...
        ['cupcake'] = math.random(35, 54),
        ['doritos'] = math.random(35, 54),
        ['icecream'] = math.random(35, 54),
        ['kaasblokjes'] = math.random(35, 54),
    },
    drink = { -- default drink items
        ...
        ['strawberrylemonade'] = math.random(35, 54),
    },
