...
Config.Locations = {
    ["main"] = {
        label = "SasVegas Towing",
        coords = vector4(671.1122, 232.9776, 94.1995, 60.0403),
    },
    ["vehicle"] = {
        label = "Flatbed",
        coords = vector4(676.7062, 245.8732, 94.0306, 239.7452),
    },
    ["dropoff"] = {
        label = "Vehicle Drop Off Location",
        coords = vector3(714.0983, 253.3740, 93.3088)
    },
    ["towspots"] = {
